...
<html lang="en">
  <head>
    ...
    <!-- Logo Title Bar -->
    <link rel="icon" href="Assets/png/logo-persagi.png"
    type="image/x-icon">
  ...
  <body>
      ...
      <div class="nav-top bg-main py-2">
        <div class="container d-flex justify-content-between">
            <p class="my-auto fw-300">Senin, 07 Agustus 2023, 21:30 WIB</p>
            <button class="btn btn-main px-3" type="button">
                Masuk
            </button>
        </div>
      </div>
      ...
      <div class="jumbotron bg-center">
        <div class="container pt-5">
            ...
            <h2 class="text-center mt-3 h2-small">Kami hadir dengan bangga sebagai Persatuan Ahli Gizi Indonesia Cabang Karawang.
      ...
      <div class="d-flex justify-content-center gap-5 bg-center">
          <div class="card" style="width: 350px height: 240px; ">
            <lottie-player src="https://lottie.host/d54a1f38-ded3-4c39-b0e5-0bbd8ec2bab2/fWj7QAu8NF.json"  background="transparent"  speed="1"  style="width: 219px; height: 163px;"  loop  autoplay></lottie-player>
            <div class="card-body">
                
            </div>
          </div>
          <div class="card" style="width: 350px height : 240px;">
            <lottie-player src=“https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js”  background="transparent"  speed="1"  style="width: 219px; height: 163px;"  loop  autoplay></lottie-player>
            <div class="card-body">
            </div>
          </div>
      ...
      <footer class="bg-white text-white text-left pt-4">
        ...
        <div class="footer-content d-flex ">
            ...
            <div class="txt-f ms-4">  <p>DPC PERSAGI</p>
            <p>KARAWANG</p>
          </div>   
        </div>
      </div>
      ...
      <div class="bg-main pt-4">
        <div class="container">
          <div class="row d-flex justify-content-center">
            <div class="col-4">
              <p class="py-2">Lorem ipsum dolor sit amet consectetur. Dictumst tristique vitae diam quis egestas magna feugiat sit vel. Cras vel ut diam facilisi feugiat eu. Et ultrices quis fames nisi convallis. Tincidunt dictum fermentum tempor pellentesque arcu faucibus at.</p>
            ...
            <div class="col-4 ps-5">
              ...
              <div class="d-flex gap-3">
                ...
                <p>Jalan Parahiyangan No.39, Adiarsa Bar., Kec. Karawang Bar., Karawang, Jawa Barat 41311</p>
              </div>
              <div class="d-flex gap-3">
            ...
            <div class="col-4 d-flex justify-content-end">
              <div class="">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.5878516681496!2d107.30447377411514!3d-6.317743861821297!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6977cebb9afa29%3A0x67e83add75c68c4a!2sJl.%20Parahiyangan%20No.39%2C%20Adiarsa%20Bar.%2C%20Kec.%20Karawang%20Bar.%2C%20Karawang%2C%20Jawa%20Barat%2041311!5e0!3m2!1sen!2sid!4v1691586432090!5m2!1sen!2sid" width="300" height="255" style="border:0; border-radius: 5px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>
            </div> 
          </div>
          <div class="row mt-3">
